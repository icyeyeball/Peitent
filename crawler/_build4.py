...
for index in range(1585023, 2200000,400):
        ...
        with open ("./parsed.txt",'r',encoding = 'utf-8') as f2:
            ...
            for line in lines:
                ...
                if line.startswith('start') == True:
                    ...
                    imageData2l = holderChineseNamel + str(line.strip().replace(u'holderChineseName =', u'')) + " "
