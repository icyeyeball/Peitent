...
cmd_users = "SELECT "+find+" FROM tmarkTable WHERE tmarkName "+ judge1
cursor.execute(cmd_users)
tmark_list11 = cursor.fetchall()
cmd_users = "SELECT "+find+" FROM tmarkTable WHERE tmarkName "+ judge1
cursor.execute(cmd_users)
tmark_list12 = cursor.fetchall()
cmd_users = "SELECT "+find+" FROM tmarkTable2 WHERE tmarkName "+ judge1
cursor.execute(cmd_users)
tmark_list21 = cursor.fetchall()
cmd_users = "SELECT "+find+" FROM tmarkTable2 WHERE tmarkName "+ judge1
cursor.execute(cmd_users)
tmark_list22 = cursor.fetchall()
cmd_users = "SELECT "+find+" FROM tmarkTable3 WHERE tmarkName "+ judge1
cursor.execute(cmd_users)
tmark_list31 = cursor.fetchall()
cmd_users = "SELECT "+find+" FROM tmarkTable3 WHERE tmarkName "+ judge1
cursor.execute(cmd_users)
tmark_list32 = cursor.fetchall()
cmd_users = "SELECT "+find+" FROM tmarkTable4 WHERE tmarkName "+ judge1
cursor.execute(cmd_users)
