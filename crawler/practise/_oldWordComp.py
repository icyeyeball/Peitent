...
for i in range(0,len(word_l1)):
    print(word_l1[i])
    for j in range(0, len(word_l2)):
        print(word_l2[j])
        print("++++++++")
        print(meaning(word_l1[i] ,word2[j]))
#print(meaning(word_l1[i],word_l2[j]))
"""
#mean_l.sort()
...
string1 = "化學、合成、氣體、催化、資源、精肥、螯合、化合物、未加工、有機土、純竹炭、添加劑、通用型、營養液、農業生技、過濾材料、複合元素、環保節油劑、BIOCHEMICAL、CARBON、CATALYST、CHELATE、CHEM、CHEMICAL、CHEMISTRY、CLEANER、COATING CHEMICAL、COMPOUND、DIESEL TREATMENT、ELEMENT、ENERGY、ENZYME、GLUE、POLYMERS、LIQUID、MEMBRANE、MICROBE、NATURAL ORGANIC LIQUID FERTILIZER、OIL SYSTEM、PREPARATION、RESOURCES、SOIL、SYNTHESIS"
string2 = "建材、彩繪、噴砂、透明漆、COLORANT、DYESTUFF、PAINT、PATCH、RUST、VARNISH"
string3 = "油、炭、香、膏、肌膚、皂物、防曬、亮顏、保濕、炫色、美甲、美白、美妝、美睫、香氛、香品、茶浴、草本、彩妝、煥白、煥膚、嫩白、緊實、蒸氣、裸妝、髮泥、髮舖、髮藝、凝露、雙效、修復露、無瑕透白、美髮沙龍、AGE、AIRBRUSH、AROMA、BEAUTY、BEAUTY LAB、BODY、BODY CARE、BOTANIC、BOTANICAL、CARE、CLEANSING、CLEAR、COMPACT、COOL GEL、CREAM、DEODORANT、DETERGENT、ESSENCE COLLECTION、ESSENTIAL OIL、FRAGRANCE、GEL、GENTLE、HAIR、HAIR CENTER、HAIR EXPERT、HAIR SALON、HANDMADE SOAP、INCENSE、MAKE UP、MAKE-UP STUDIO、MILK、MOIST、OIL、PET、PROTEIN、Q10、RELAX、SKIN、SKINCARE、SPA、SPF(+防曬系數) 、SPRAY、UV、VEIL、WASH"
string4 = "油品、照明、水素化、高性能技術、CHEM、ENERGY、ILLUMINATING、LIGHTING、RACING、SPEED、TRANSMISSION"
string5 = "丸、丹、液、散、貼、酵、錠、好菌、益菌、高鈣、滋養、順暢、漢方、製藥、輕食、膠原、膠囊、蔘藥、複方、凝膠、機能、營養、一條根、益生菌、植物性、生機飲食、保健食品、草本精華、健康主張、御醫漢方、膠原蛋白、Ｃ片、BIO PHARMA、BIOTECHNOLOGY FOODS、CALCIUM、CAPSULE、CARE、CHINESE MEDICINE、CURE、DERMA、DIET、DNA、DRUG、FLUID、FORMULA、GEL、GENE、HERBACEOUS PLANT、HERBAL、HYGIENE、LUTEIN、MEDICINE、NUTRITION、NUTRITIONAL、OMEGA-3、PELLET、PHARMA、PHARMACEUTICAL、PILL、PLASTER、POWDER、PREPARATION、Q10、TABLET THERAPEUTIC、TONIC、VANILLA"
string6 = "耐震、氣密、密封、補強、隔震、擠型、鑄造、高安全性、AIR-TIGHT、ANTI-SHOCK、CAST／CASTING、HIGH SECURITY、REINFORCE"
string7 = "氣動、傳動、電動、鑄造、機器人、AIR、COATING、CUT、DRIVE、ELECTRONIC、FORGE、GEAR、IC、MACHINERY、MILL、REFRIGERATION、ROBOT"
string8 = "工具、美甲、髮藝、AUTO TOOLS、BARBER、CUTTING、GRIP、HAIR CUT、SET 、TOOLS"
...
string10 = "植牙、電位、機器人、情趣用品、ACUPUNCTURE、BONE、CARE、DENTAL、DIAGNOSTIC、ELECTRICAL、HEAT THERAPY、HOMECARE、IMPLANT、INSTRUMENT、LASER、MAGNETISM、MASSAGER、MEDICAL、MEDICAL PRODUCTS、METER、OPTIC、ORTHOPEDIC PRODUCTS、ORTHOPEDICS、PAD、PRESSURE THERAPY、PROSTHETIC、PROTECT、PULSE、ROBOT、SAFETY、SHIATSU、SUPPORTS、THERAPEUTICS、VEIN"
string11 = "光能、空調、活水、淨水、照明、節能、蒸氣、衛浴、變頻、AIR、AQUA、BRIGHT、CHEF、COOL、FROZEN、GAS、H.I.D.、ILLUMINATED、LIGHTING、PURIFY、REFRIGERATION、SOLAR、SOLAR POWER、SPA、WATER、WATER SAVE"
string12 = "小折、小摺、車業、省油、動力、太陽能、全地形、電動的、四輪傳動、懸吊系統、ATV、AUTO、AUTOMOTIVE、AVIATION、BIKE、CYCLE、CYCLING、DRIVE、ELECTRONIC、FORGED、GEAR、GENUINE、GOLF、HYBRID、KIDS、LED、MOBILE、MOTOR、OFF-ROAD、OUTDOOR、POWER、RACING、RACING SPEED、RV、SOLAR、SPEED、SPORT、SUSPENSION、SUV、TOOLS、TURBO、VIEW"
string13 = "防狼、火力強、EXPLODE、EXPLOSIVE"
string14 = "金飾、純金999、精準、銀樓、金仔店、BEAD、BEAUTY、CRYSTAL、EXCLUSIVE、GEMOLOGY、GEMSTONE、GOLDEN、JEWEL、JEWELLERY、TREASURE、ZIRCONIA"
string15 = "音樂、管樂、爵士、音樂館、打擊樂團、音樂學校、數位音樂中心、音樂教育系統、音樂文化教育機構、GOOD SOUND、GUITAR STUDIO、JAZZ、JAZZY、MUSIC、MUSICAL EDUCATION OBJECT、PERCUSSION、STRINGS"
string16 = "卡、袋、報、膜、文具、文理、日報、日語、月刊、出版、包裝、快訊、快報、美語、英文、時報、書局、書法、紙紮、教育、教室、週刊、黃頁、電玩、網咖、製作、數學、樂透、親子、書畫室、腦力開發、BAG、BINDERY、BOOKSTORE、CARD、DAILY、DIGEST、EDUCATION、ENGLISH、JOURNAL、LEARNING、MONTHLY、PACKAGE、PAPER、PHOTO、PRESS、PRINT、PRINTING、PUBLISHING、SEAL、STATIONERY、TICKET、WEEKLY、WRAPPING"
string17 = "酯、吸音、黏彈性、ACOUSTIC、TPU、VISCOELASTIC"
string18 = "杖、袋、箱、皮件、皮飾、寵物、CLOTH、COVER、FUNCTIONAL、HOLDER、JEAN、PET、SKIN、STICK、STRAP"
string19 = "耐震、補強、隔震、ANTI-SHOCK、REINFORCE、SAND"
string20 = "名床、家居、傢飾、寢飾、實木、廚飾、系統傢俱、精緻名床、BEDDING、BOARD、CASA、FITMENT、FURNITURE、HOME COLLECTION、HOUSEHOLD、INFANT、MATTRESS、PALLET、SLEEP、SYSTEM FURNITURE、WARE"
string21 = "生活、咖啡、美甲、家居、琉璃、彩妝、清潔、陶瓷、廚房、窯燒、鍋物、家庭用具、廚房用具、CHEF、CHINA HOUSE、CHINAWARE、COFFEE、COOL、COSMETICS、CRYSTAL、DRINK、KITCHENWARE、WASHER"
string22 = "帶、篷、紗網、紡織品、BAND、CHARCOAL、TAPE、TENT"
string23 = "炭、麻、羊毛、織品、纖維、紡織品、嫘縈織物、FABRIC、FIBERS、FLEECE、HEMP、NYLON、RAYON、SILK、WOOL"
string24 = "絨、絲、尼龍、竹炭、羊毛、乳膠、家居、紡織、寢具、寢飾、睡眠、製棉、編織、蕾絲、織物、炭元素、備長炭、創意家飾、精緻名床、寢具生活館、睡眠生活館、BEDDING SET、CLOTH、COOL、DECORATION、FABRIC、HOME CARE、HOME COLLECTION、KNITTING、LACE、LASTING、LATEX、NYLON、PEVA、SATEEN、SCREEN、SILK、SLEEPING、SPINNING、WEAVE、WOOL"
string25 = "麻、棉、絲、羊毛、服飾、速乾、塑身、團服、ATHLETIC、CLOTH、COTTON、DENIM、DRESS、FABRIC、GEAR、JEANS、LINEN、RAYON、SILK、SPORT、UNIFORM、WEAR、WOOL、YARN"
string26 = "扣、針、帶、絲、鉤、飾品、BAND、BEADS、DARN、EMBROIDERY、HAIR、HOOK、ORNAMENT、SEWING、SNAP"
string27 = "炭、竹炭、瑜珈、BAMBOO、PE、YOGA"
string28 = "卡、盒、手遊、娃娃、桌遊、密技、瑜珈、遊戲、運動、體操、體育館、虛擬實境、BIKE、BOARD GAMES、BOXING、CARD、DANCING、DART、DRIVE、GAME、GOLF、INFANT、MOTORSPORT、OUTDOOR、PETS、PLAY、PLAYING FIELD、ROBOT、SPORT、SPORTS、SURFER、VIRTUAL REALITY、VR"
string29 = "肽、湯、酵、元素、水產、生鮮、冰鎮、串燒、厚切、厚片、厚燒、活菌、益菌、茶事、茶油、酒食、現熬、順暢、漢方、機能、燉品、燒烤、肉脯店、香 QQ、麻辣燙、低溫殺菌、烘焙美食、高纖順暢、黃金泡菜、BAKER、BBQ、BIOTECHNOLOGY FOODS、BRUNCH、DIETARY、FLAVOR COATED、FRAGRANCE、FROZEN、HERBACEOUS PLANT、HONEY、NUTRITION、SANDWICHES、SEAFOOD、SPARKLING、STEAK、VEGETARIAN FOODS、XO、YOGURT"
string30 = "味、香、脆、茗、酥、辣、酵、燒、饌、お茶、二代、上純、川味、手工、手烘、手搖、日式、外賣、奶香、甘醇、生酮、冰室、冰鎮、多酚、好米、好食、百草、百菓、老茶、西點、串燒、夾心、快餐、佳釀、呷茶、呷涼、果香、油切、法式、空廚、長秈、厚切、厚燒、研磨、美式、美饌、香Ｑ、香茗、凍頂、凍飲、泰式、烘培、素食、茗品、茗茶、茶王、茶事、茶油、茶舍、茶品、茶苑、茶宴、茶庵、茶集、茶飲、茶道、茶點、茶禮、酒食、御廚、御膳、現烤、陳年、麻辣、焙茶、無糖、發酵、粥品、菓子、新茶、義式、蜀味、補給、農法、零食、漢方、碳烤、精釀、製粉、製茶、製菓、製麵、輕飲、樟芝、穀香、窯烤、蔗香、養身、燒烤、燜燒、優糧、薄燒、鮮味、鮮果、點心、一口酥、三合一、天然ㄟ、功夫茶、台灣餅、四物飲、私房菜、芋冰城、味一番、咖啡棧、活力菌、活性菌、活性酶、家鄉味、純黑糖、茶博館、清心茶、陳年釀、植物派、減脂茶、葉黃素、零度C、養生粥、養生鍋、醍醐味、纖體素、手釀原液、日本料理、台灣料理、自家烘焙、自家製麵、忠於原味、活力元氣、活性元素、美食天地、原味燒烤、烘焙美食、祖傳名產、茶色茶香、迴轉壽司、健康主張、健康總匯、專業烘焙、甜而不膩、傳統美食、葡式蛋撻、調味專家、養蜂農場、營養強化、禮餅專家、懷石料理、西點麵包店、純古法釀造、義大利風味、自然生態農場、BAKERY、BAKING、BBQ、BEANS、BEVERAGE、BIOTECHNOLOGY FOODS、BLEND COFFEE、BRUNCH、BURGER、CAFE、CHA、CHIP、COFFEE FARM、CONFECTIONARY、COOKED、COOL、CURRY、DESSERT、DHA、DIET、DIETARY、DRINK、FOODS、FRESH FRUIT、FRUIT、GOURMET、HEALTHY CARE、HERBACEOUS PLANT、HERBAL、HONEY、ICE SHOP、JAPANESE FOOD、KUNG FU TEA、MEAL、NATRUAL HEALTH、NATURAL CHOICE、PASTA、PIE、RAMEN、ROASTER、SABU、SHABU、SMOKY、SOFT、SPARKLING、SUSHI、TAIWANESE CUISINE、TEA、THREE IN ONE、TRI IN ONE、VANILLA、YUMMY"
string31 = "花市、花店、高冷、超大、園藝、溫室、鮮切、鮮味、鮮果、寵物、蘭園、蘭藝、野菜村、水族量販、休閒農場、活蝦之家、農特產品、綠色生機、FRESH FRUIT、FRESH GARDEN、GARDENING、HERBACEOUS PLANT、PETFOOD、TROPICAL"
string32 = "酵、冰泉、冰鎮、好水、保鮮、活水、凍飲、純水、酒食、淨水、飲料、精釀、鍺水、檸檬、大悲水、六角水、甘露水、果汁吧、活氧水、纖果粒、ALOE、BEVERAGES、BREWERY、BREWING、BRUNCH、COLLAGEN、DRY、ENERGY、ENZYME、FOODS、FRESH JUICE、HERBACEOUS PLANT、JUICE BAR、LIGHT、MALT、MEDIUM-DRY、MINERAL、NATURAL HEALTH、NON-ALCOHOLIC、OXYGEN、O2、PURE WATER、Q10、SEA WATER、SEMI-DRY、SPARKLING、STRAWBERRY、WINEMAKER"
string33 = "醇、古酒、冰鎮、名酒、酒場、酒窖、酒廠、酒藏、窖藏、精釀、蒸餾、釀製、長壽酒、葡萄園、陳年老酒、越陳越香、酒精濃度（38度）、ALCOHOLIC DRINKS、ALCOHOLIC BEVERAGES、BREWERY、BREWING、CASK、CELLAR、DISTILLED、DRY、HERBACEOUS PLANT、MEDIUM-DRY、SEMI-DRY、SINGLE MALT、SPARKLING、VANILLA、VINEYARD、WINE CELLAR、WINE HOUSE、WINEMAKER、WINERY"
string34 = "菸酒、慢燃、濃煙、活性碳、手工煙斗、DENSE、FILTER、RIPENED TOBACCO、SLIMS、SMOKING"
string35 = "水產、市場、夜市、花店、建經、量販、會展、網購、藥粧、人文館、名品城、百貨店、伴手禮、金仔店、人力銀行、生活工坊、生活百貨、國際貿易、就業情報、線上購物、親子購物、3C、AD.、HR、BIG SALE、BUY、CONSULT、CONSULTANT、DISTRIBUTION、EXHIBITS、MANPOWER、MERCHANT、PAY、POINTS、PRODUCE、PROMOTIONS、SHOPPING"
string36 = "人壽、公寓、日租、比價、地產、房屋、法拍、金流、金融、致富、財富、基金、理財、產物、產險、票券、眾籌、票券、資本、權證、投資銀行、物業管理、國際地產、產物保險、理財金三角、BROKER、CAPITAL PARTNERS、CROWD FUNDING、EXCHANGE、FINANCIAL、FINANCIAL SOLUTIONS、FUND、FUTURES、INCUBATOR、INTERNATIONAL PROPERTY、INVESTOR、LOAN、PAY、REALTY、REWARDS、RISK MANAGEMENT、SECURITY、STOCK、TAX、WEALTH MANAGEMENT"
string37 = "包膜、快修、速修、造景、景觀、節能、鋼構、自助洗車、車體美容、室內裝修、維修中心、ARCHITECT DEVELPOMENT、ARCHITECTURE & INTERIOR、AUTO SERVICE、AUTOMOTIVE BEAUTY、BUILDER、CAR BEAUTY、CAR SPA、DECO、DEVELPOMENT、HOUSING"
string38 = "報、有線、副刊、移動、報導、無線、新聞、漫遊、網聯、寬頻、數據、頻道、旅遊台、部落格、電視台、人造衛星、行動上網、電訊聯盟、數位行動通訊、4G、5G、BLOG、CABLE、CALL、CHANNEL、CLOUD、CONNECT、GPS、HD、LTE、MOBILE、PAY、RADIO、REPORT、SIM、STREAM、TELECOM、TV、WAP、WIRED、WIRELESS"
string39 = "叫車、打車、壯遊、快車、快送、車隊、便利、客運、倉庫、旅行、航空、假期、商船、捷旅、速遞、無線、郵輪、遊艇、遊輪、運通、慢遊、聯運、觀光、自由行、旅遊台、迷你倉、遊覽車、衛星車隊、AIR、AIRLINE、AVIATION、CAB、CARGO、CRUISE、CRUISE LINE、GPS、HARBOUR、HOLIDAY、JOURNEY、MINI STORAGE、PARK、PARKING、RESERVATION、SHIPPING、SOLAR POWER、SPEED、TAXI、TRANSPORT、VACATION、YACHT"
string40 = "代工、加工、油壓、塗裝、鍍膜、CHIP、COATING、TAILOR"
string41 = "塾、誌、大學、才藝、戶外、手遊、文理、文藝、休閒、年會、有氧、武術、美術、美語、英文、音樂、拳擊、書法、桌遊、氣功、教室、會展、瑜珈、義塾、數學、樂園、樂團、閱讀、學舍、學校、學院、學堂、親子、戲院、賽事、藝苑、藝能、露營、人文館、出版社、合唱團、紀念館、美術館、健康館、釣蝦場、渡假村、照相館、電音節、歌舞團、舞蹈團、翻譯社、人力發展、文教機構、休閒廣場、品格教育、音樂中心、留學中心、健身中心、教育中心、教學系統、森林樂園、運動中心、運動平台、運動空間、運動訓練、語言學坊、數位學堂、藝術特區、文理補習班、學習實驗室、ABROAD、ACADEMIA、ANNUAL MEETING、ART CENTER、BAND、BOOKS、BOOKSTORE、BOXING、CAMPING、CASINO、CHOIR、DANCE、DANCE THEATRE、DRAMA、EDUCATION INSTITUTE、FESTIVAL、GOLF、LANGUAGE WORKSHOP、LEARNING LAB、LEISURE、MEMORIAL HALL、MUSIC、NATIONAL PARK、ONWEB、OUTDOOR、PROMOTIONS、PUBLISHING、RACING SPORT、TICKET、UNIVERSITY、VACATION、VIDEO、VIRTUAL REALITY、VR、YOGA"
string42 = "生物、研發、部落格、系統傢俱、空間創作、視覺設計、雲端計算、ANALYSIS、ARCHITECT DEVELPOMENT、ARCHITECTURE & INTERIOR、BLOG、CAD、CLOUD、CONNECT、DECO、DESIGN STUDIO、ECOSYSTEM、QUALITY ASSURANCE、UPDATE"
string43 = "丼、饌、小站、川味、手搖、文旅、日式、水產、火烤、主廚、外賣、民宿、全素、冰鎮、托育、托嬰、早點、行旅、行館、串燒、私廚、定食、法式、青旅、厚切、厚燒、炭燒、美式、食補、泰式、烘焙、素食、茶事、茶舍、茶室、茶庵、茶集、茶齋、酒食、御廚、御膳、捷旅、麻辣、越菜、飯包、意麵、會展、義式、蜀味、團膳、輕食、輕旅、輕飲、廚藝、熱炒、窯烤、蔬食、燒肉、燒烤、燒臘、親子、餐旅、鍋物、鍋燒、鮮味、鮮食、鮮萃、簡餐、早午餐、自助餐、宴會廳、家常菜、臭臭鍋、麻辣燙、渡假村、獨享鍋、鴛鴦鍋、麵食館、鐵板燒、自家製麵、私房美饌、青年旅館、烘焙美食、健康湯鍋、國際行館、森林樂園、渡假飯店、港式飲茶、港式燒臘、港式點心、溫泉拉麵、精品旅店、複合餐飲、懷石料理、墨西哥料理、B&B、BAKER、BAKERY、BANQUET、BBQ、BED & BREAKFAST、BRUNCH、BUFFET、BURGER、BUSINESS HOTEL、CAFÉ、CAPSULE INN、CHEF、CUISINE、CURRY、DINER、EATERY、EXPRESS HOTEL、FOOD、FOOD STAND、FRIED CHICKEN、GOURMET、GRILL、HAND-PICKED、HOME STAY、HOSPITALITY、JUICE BAR、LOUNGE、NOODLES、PIZZA、POT、ROASTER、SEAFOOD、SABU、SHABU、SHABU SHABU、SNACK STATION、SPA、STEAK、SUITE、SUSHI、TEA BAR、TEPPANYAKI、THE BAKERY、VACATION、VILLA、YUMMY"
string44 = "月嫂、芳療、美白、紋身、紋繡、湯屋、新秘、雷射、髮藝、醫美、超音波、微整型、養生館、整復所、醫生館、月子中心、安養中心、長照中心、紀念醫院、美容世界、專業彩妝、彩妝造型、造型團隊、創意髮型、愛犬沙龍、養護中心、寵物沙龍、藝術指甲、護髮中心、足體養生館、美容美體館、足體養生會館、健康諮詢中心、產後護理之家、AESTHETIC MEDICINE、BARBER、BEAUTY CARE、BEAUTY SPA、CARE、CLINICAL DIAGNOSTICS、DERMA、EYELASH SALON、FOOT MASSAGE & SPA、HAIR、HAIR CUT、HAIR EXPERT、HAIR SALON、HAIR STYLE、LASER、LONG-TERM CARE、MAKE UP、NAIL SPA、OPTICS、PET SALON、POSTPARTUM CARE CENTER、SHOWER、SPA、SURGERY、TATTOO、THERAPEUTICS、VET"
string45 = "壇、生命、宗壇、婚友、婚紗、婚禮、徵信、囍事、禮儀社、生命事業、物業管理、法律事務所、HOME CARE、WEDDING"
...
string = string00+string01+string02+string03+string04+string05+string06
