...
def wordsEng2(word1, word2):
    ...
    if len(dependst)<50 or len(depends2t)<50:
        ...
        if p1_total>p2_total:
            ...
            p_l_max = p2_l.copy()
            p_l_min = p1_l.copy()
        print("Pmax = " + str(p_max_avg))
        print("Pmin = " + str(p_min_avg))
        ...
        for i in range(0,len(p_l_min)):
            ...
            if len(dependst) <= 5:
                if m_i < 2 or (m_i >= 4 and m_i < 5):
                    ...
                    print("f_i = " + str(f_i))
                    print("g_i = " + str(g_i))
                    print("len(depends2t) = " + str(len(dependst)))
                    print("lnAmin = " + str(math.log(len(dependst))))
                    print("q_i = " + str(q_i))                
                ...
                if m_i < 5:
                    ...
                    print("g_i = " + str(g_i))
                    print("len(depends2t) = " + str(len(dependst)))
                    print("ln6 = " + str(math.log(len(dependst))))
                    print("q_i = " + str(q_i))
                    print("y_total = " + str(y_total*100))
                elif m_i >= 5:
        ...
        if len(dependsii)+abs(p1_l[0]-p2_l[0]) > 0:
            r = n_char/(len(depends2t)+abs(p1_l[0]-p2_l[0]))
