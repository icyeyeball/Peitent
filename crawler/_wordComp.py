...
string0 = str0+string00+string01+string02+string03+string04+string05+string06
...
# 2 to 6
weight_l = [[0.6,0.4,0,0,0,0],[0.45,0.3,0.25,0,0,0],[0.35,0.25,0.2,0.2,0,0],[0.35,0.25,0.1,0.1,0.1,0.1],[0.35,0.25,0.1,0.1,0.1,0.1]]
num = 0
subword = ""
flag = True
