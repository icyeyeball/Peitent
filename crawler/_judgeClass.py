...
word = sys.argv[1]
codeClass= sys.argv[2]

if word.find("及") > 0 and word.find("圖") > 0:
    print("文字 圖片")
    word = word[0:word.find("及")]
    print(word)
...
string0 = str+string00+string01+string02+string03+string04+string05+string06
